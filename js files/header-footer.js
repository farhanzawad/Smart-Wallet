...
if (document.getElementById("headerUsr")) {
    ...
    document.getElementById("header").innerHTML = `<div class="flex flex-col md:flex-row justify-center md:justify-between items-center py-10">
        ...
        <a href="login.html" class="hidden md:flex">
            <div class="cart p-3 border rounded-full hover:cursor-pointer hover:bg-gray-200 transition ease-in-out duration-300 hover:drop-shadow-md hover:border-gray-400 dark:hover:text-gray-950 dark:hover:shadow-slate-50">
